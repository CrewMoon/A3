...
public class CameraManager : MonoBehaviour
{
    ...
    public const float cameraDistancePersp = 20.0f;
    public const float cameraDistanceOrtho = 20.0f;
    ...
    public static readonly Vector3 indicatorOffsetVector = 
        new Vector3(0.0f, ModelsManager.cellSize, 0.0f);
    ...
    public GameObject focalPointIndicator;

    /*********************************** METHODS ***********************************/  

    public Camera getMainCamera() { return cam; }

    /// <returns>false: normal, perspective; true: tactical, orthogonal</returns>
    public bool getMode()
    {
    ...
    /// </summary>
    /// <param name="mode">false: normal, perspective; true: tactical, orthogonal</param>
    ...
    /// </param>
    public void onFocalPointMove(Vector3 newFocalPoint)
    {
        Utility.MyDebugAssert(newFocalPoint.y == focalPoint.y, "Should not move up or down.");

        focalPoint = newFocalPoint;
        updateCameraTrans();

        focalPointIndicator.transform.position = focalPoint + indicatorOffsetVector;
    }
    ...
    void Awake()
    {
        ...
        // indicator
        {
            Utility.MyDebugAssert(focalPointIndicator != null, "Set the prefab in the editor.");
            focalPointIndicator = GameObject.Instantiate
            (
                focalPointIndicator,
                focalPoint + indicatorOffsetVector,
                Quaternion.identity
            );
        }
