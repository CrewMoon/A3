...
public class UIManager : MonoBehaviour
{
    ...
    /// <summary>
    /// Switch from menu1 to menu2.
    /// Will set the camera and active state.
    /// </summary>
    /// <param name="menu1">the now active menu</param>
    /// <param name="menu2">the to be active menu</param>
    public void switchMenu(GameObject menu1, GameObject menu2)
    {
    ...
    private void attachMenuToCamera(GameObject menu)
    {
        ...
        // Do not need to do this, because BNG handles this for me.
        //menu.GetComponent<Canvas>().worldCamera = cam;
