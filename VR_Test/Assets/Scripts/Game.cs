...
public sealed class Game : MonoBehaviour
{
    ...
    public readonly InputManager inputMgr;
    ...
    // players
    ConcreteChessPlayer player1;
    ConcreteChessPlayer player2;
    ...
    public void Awake()
    {
        ...
        player1 = p1Obj.GetComponent<HumanChessPlayer>() as ConcreteChessPlayer;
        player2 = p2Obj.GetComponent<AIChessPlayer>() as ConcreteChessPlayer;
        ...
        // set the sides
        player1.setSide(Board.BoardPositionState.PLAYER1);
        player2.setSide(Board.BoardPositionState.PLAYER2);
    }
